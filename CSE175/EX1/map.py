...
#
# Izaac Ramirez
# Helper: Angelo fatali explained to me how to look through a nested dictionary using a whiteboard
# use this link to understand dictionaries syntax: https://stackoverflow.com/questions/25833613/safe-method-to-get-value-of-nested-dictionary
...
class RoadMap:
    ...
    def path_cost(self, start, road_list):
        ...
        currentCost = self.connection_dict.get(start, {}).get(path)
        ...
        while (count < len(road_list)): 
            ...
            currentCost = self.connection_dict.get(tempPath, {}).get(path)
